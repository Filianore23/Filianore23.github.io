...
const html = "<p>It may be recommended to generate policies from <a href=\"https://policymaker.io\" rel=\"nofollow, noopener, noreferrer\" target=\"_blank\">PolicyMaker.io<span> ↗</span></a>.</p>";
				...
				const frontmatter = {"layout":"@/layouts/IndividualPage.astro","title":"Terms and Conditions","description":"Last updated: 2024-11-26","language":"En","back":"/terms/list","minutesRead":"1 min read"};
				const file = "/Users/mac/project-test/src/pages/terms/terms-and-conditions.md";
