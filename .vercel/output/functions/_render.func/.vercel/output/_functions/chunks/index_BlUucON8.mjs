const id = "music-journey/index.md";
						const collection = "post";
						const slug = "music-journey";
						...
						const data = {title:"The Impact of Technology on the Music World",description:"The evolution of music is a symphony of creativity, rhythm, and technology.",publishDate:new Date(1732924800000),heroImage:{src:
						new Proxy({"src":"/_astro/thumbnail.Cx18cRmB.jpg","width":3840,"height":2160,"format":"jpg","fsPath":"/Users/mac/project-test/src/content/post/music-journey/thumbnail.jpg"}, {
					...
					,color:"#B4C6DA"},draft:false,tags:["markdown","example"],language:"English"};
						const _internal = {
							type: 'content',
							filePath: "/Users/mac/project-test/src/content/post/music-journey/index.md",
							rawData: undefined,
						};
